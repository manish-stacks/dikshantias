    ...
    useEffect(() => {
        const fetchCourses = async () => {
            try {
                ...
                const offlineCourses = data.filter(
                    (course: Course) => course.courseMode === "offline"
                );
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 p-6">
                {[1, 2, 3, 4].map((i) => (
                    ...
                    >
                        ...
                        <div className="mt-2 w-24"><Skeleton height={20} /></div>
                        <div className="mt-3"><Skeleton width={`80%`} height={22} /></div>
                        <div className="flex items-center gap-2 mt-2">
                            <Skeleton width={60} height={18} />
                            <Skeleton width={80} height={18} />
                        </div>
                        <div className="mt-2"><Skeleton width={100} height={16} /></div>
                 ...
                 transition-all duration-300 hover:bg-[#b00008] hover:scale-105 flex items-center gap-2"
                            >
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    stroke="currentColor" className="w-5 h-5 transition-transform duration-300 group-hover:translate-x-1">
