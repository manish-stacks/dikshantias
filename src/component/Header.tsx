  ...
  return (
    <div className="w-full">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-0">
          <div className="flex items-center justify-between h-14 md:h-16">
            ...
            <nav className="hidden lg:flex items-center space-x-4">
              <Link
                href="/about-us"
                className="text-gray-900 hover:text-red-500 font-medium py-2"
              >
                {t("about")}
              </Link>
              <Link
              ...
              <div className="hidden md:flex items-center space-x-2 text-gray-900">
                ...
                <div className="text-sm">
                  ...
                  <div className="font-medium">
                    <a href="tel:09312511015">+91 9312511015</a>
                  </div>
                </div>
              </div>
      ...
      >
        ...
        ></div>
        <div
          className={`fixed left-0 top-0 h-full w-80 bg-white shadow-lg transform transition-transform duration-300 ease-in-out ${isMobileMenuOpen ? "translate-x-0" : "-translate-x-full"}`}
        >
            ...
            <nav>
              <div className="border-b border-gray-200">
                <Link
                  href="/about-us"
                  onClick={toggleMobileMenu}
                  className="block py-1 text-gray-900 hover:text-red-500 font-medium"
                >
                  {t("aboutDikshant")}
                </Link>
              </div>
              ...
              <div className="border-b border-gray-200">
                ...
                >
                  <span>{t("courses")}</span>
                  <ChevronDown
                    className={`w-4 h-4 transition-transform duration-200 ${openMobileDropdown === "courses" ? "rotate-180" : ""}`}
                  />
                </button>
                <div
                  className={`overflow-hidden transition-all duration-300 ${openMobileDropdown === "courses" ? "max-h-48 opacity-100" : "max-h-0 opacity-0"}`}
                >
                  <div className="ml-4 space-y-2 pt-2">
                    ...
                    <Link
                      href="/offline-course"
                      onClick={toggleMobileMenu}
                      className="block border-b border-gray-200 py-1 text-gray-700 hover:text-red-500"
                    >
                      {t("offlineMode")}
                    </Link>
              ...
              <div className="border-b border-gray-200">
                ...
                >
                  <span>{t("currentAffairs")}</span>
                  <ChevronDown
                    className={`w-4 h-4 transition-transform duration-200 ${openMobileDropdown === "currentAffairs" ? "rotate-180" : ""}`}
                  />
                </button>
                <div
                  className={`overflow-hidden transition-all duration-300 ${openMobileDropdown === "currentAffairs" ? "max-h-64 opacity-100" : "max-h-0 opacity-0"}`}
                >
                  <div className="ml-4 space-y-2 pt-2">
                    {subCategories.map((item) => (
                      <Link
              ...
              <div className="border-b border-gray-200">
                <Link
                  href="/scholarship-programme"
                  onClick={toggleMobileMenu}
                  className="block py-2 text-gray-900 hover:text-red-500 font-medium"
                >
                  {t("scholarship")}
                </Link>
              </div>
              ...
              <Link
                href="/blogs"
                onClick={toggleMobileMenu}
                className="block py-2 text-gray-900 hover:text-red-500 font-medium border-b border-gray-200"
              >
                {t("blogs")}
              </Link>
            </nav>
