...
export default function HeroSlider() {
  ...
  const courses = [
    ...
    },
    {
      ...
      color: "bg-yellow-200",
      icon: "🎥",
      link: "current-affairs/what-to-read-in-hindu",
    },
    {
      id: "c3",
      name: "What to Read in The Indian Express",
      color: "bg-green-200",
      icon: "🏫",
      link: "current-affairs/what-to-read-in-indian-express",
    },
    {
      id: "c4",
      ...
      color: "bg-pink-200",
      icon: "✍️",
      link: "current-affairs/daily-current-affairs-analysis",
    },
    {
      id: "c5",
      ...
      color: "bg-red-200",
      icon: "📚",
      link: "current-affairs/editorial-analysis",
    },
    {
      id: "c6",
      ...
      color: "bg-blue-200",
      icon: "👥",
      link: "current-affairs/important-facts-of-the-day",
    },
  ];
    ...
    <div className="bg-white -mt-14 md:mt-3 mx-2">
      ...
      <div className="container max-w-7xl mx-auto md:mt-0 mt-4 md:py-8">
        <h2 className="text-xl md:text-3xl font-bold mb-4 text-[#040c33] pl-2 md:pl-0">
          {t("latestNews")}{" "}
          <span className="text-[#f43144]">{t("updates")}</span>
        </h2>
        <Swiper
          modules={[Autoplay]}
          spaceBetween={8}
