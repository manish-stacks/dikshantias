...
const CoursePage = () => {
  ...
  useEffect(() => {
    ...
    const fetchCourse = async () => {
      try {
        const res = await fetch(`/api/admin/frontend/courses/${slug}`, {
          cache: "no-store",
        });
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (res.ok) {
      setSuccess(
        "Thank you for your enquiry! Our team will contact you shortly with course details.",
      );
      setError("");
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-blue-950 text-sm">
                          ...
                          explained complex topics in a clear and engaging way,
                          with practical examples that I could immediately
                          apply. The content was well-structured, and the
                          exercises helped reinforce my learning. I feel much
                          more confident in my skills now and would highly
                          recommend this course to anyone looking to level up."
                        </p>
                      </div>
                    </div>
                  </div>
          ...
          <div className="w-full lg:w-80">
            <div className="lg:sticky lg:top-8">
              <div className="bg-white rounded-lg shadow-lg overflow-hidden">
                ...
                <div className="p-6">
                  <div className="text-2xl font-bold text-[#040c33] mb-6">
                    ₹ {course.price}/{" "}
                  ...
                  <div className="space-y-4 text-sm">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-blue-950">
                        Number of hours: {course.lectures}
                      </span>
                    </div>
                    <div className="flex items-center gap-3">
              ...
              <div className="mt-6 bg-gradient-to-br from-gray-900 to-red-900 rounded-lg overflow-hidden text-white">
                <div className="p-6">
                  ...
                  <p className="text-sm text-gray-300 mb-4">
                    Fill in the form below and our team will contact you with
                    complete course details.
                  </p>
                  {success && (
                    <p className="text-green-400 text-sm mb-2 mt-3">
                      {success}
                    </p>
                  )}
                  {!success && error && (
