    ...
    const Page: React.FC = () => {
      ...
      // ✅ fetch arrays from translation
      const notesSteps = t("scholarships.notes", { returnObjects: true }) as string[] | string;
      const applySteps = t("scholarships.apply", { returnObjects: true }) as string[] | string;
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 items-center px-2 md:px-0'>
              <div>
                <div className='content md:pr-4 md:pt-4 text-center md:text-start'>
                  ...
                  <p className='text-justify text-blue-950'>{t("scholarships.desc1")}</p>
                  <p className='text-justify text-blue-950'>{t("scholarships.desc2")}</p>

                  <h3 className='font-bold mt-4 text-[#040c33]'>{t("scholarships.funded")}</h3>
                  <p className='text-justify text-blue-950'>{t("scholarships.register")}</p>
                </div>
              </div>
              <div>
